...
import { X, Mail, User, Lock, Loader2, Sparkles } from "lucide-react";
          ...
          >
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-xl font-semibold text-[#f7f8f8]">Create your account</h2>
                  <p className="text-[13px] text-[#8a8f98] mt-1">Start building your AI context layer.</p>
                </div>
                <button
                  onClick={handleClose}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-[13px] text-[#8a8f98] mb-1.5 font-medium">Name</label>
                  <div className="relative">
                    <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#62666d]" />
                    <input
                      type="text"
                      value={name}
              ...
              <p className="text-center text-[13px] text-[#8a8f98] mt-4">
                ...
                <button onClick={onSwitchToLogin} className="text-[#7170ff] hover:text-[#828fff] transition-colors">
                  Sign in
                </button>
              </p>
            </div>
