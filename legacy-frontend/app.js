...
const I18N = {
 ...
 'myData.uploadHint': 'รองรับ PDF, DOCX, TXT, MD, CSV, PNG/JPG/HEIC (OCR), GIF/BMP/TIFF, XLSX, PPTX, HTML, JSON, RTF · สูงสุด 200 MB · ครั้งละ 20 ไฟล์',
 ...
 'myData.uploadHint': 'Supports PDF, DOCX, TXT, MD, CSV, PNG/JPG/HEIC (OCR), GIF/BMP/TIFF, XLSX, PPTX, HTML, JSON, RTF · max 200 MB · up to 20 files at once',
