...
- `scripts/duplicate_detection_smoke.py` (33 cases) — script removed in 2026-05-14 cleanup; restore from git history when re-enabling dedup
...
4. Restore + run `scripts/duplicate_detection_smoke.py` from git history → expect 33/33 PASS
