...
**Plan ที่อ้างอิง:** [rebrand-pdb.md](rebrand-pdb.md)
...
1. อ่าน Plan ฉบับเต็มใน [rebrand-pdb.md](rebrand-pdb.md) แล้ว
...
3. ✅ ทำตาม Plan Step 1-10 ใน [rebrand-pdb.md](rebrand-pdb.md):
...
> **เมื่อกลับมาทำงานต่อ:** อ่านไฟล์นี้ + อ่าน [rebrand-pdb.md](rebrand-pdb.md) ก็พอ ไม่ต้อง grep ใหม่
